...
upsert_env_value "NEXT_PUBLIC_SITE_URL" "https://neutraldevelopment.com" ".env.vps.production"
upsert_env_value "NEXT_PUBLIC_API_URL" "https://api.neutraldevelopment.com" ".env.vps.production"
upsert_env_value "NEXT_PUBLIC_SITE_URL" "https://staging.neutraldevelopment.com" ".env.vps.staging"
